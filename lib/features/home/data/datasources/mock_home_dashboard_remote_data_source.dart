...
class MockHomeDashboardRemoteDataSource implements HomeDashboardRemoteDataSource {
  ...
  @override
  Future<TripModel> registerPassenger(String id, String dni, [String? status, String? category, String? registrationMethod, double? lat, double? lng, String? justification, String? uidCliente, String? nombreCompleto, String? empresa, int? paraderoId, String? lugarSubida, String? puesto, String? unidad]) async {
    await Future.delayed(const Duration(milliseconds: 300));
