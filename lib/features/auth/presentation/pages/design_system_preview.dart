  ...
  Widget _buildTokensTab(BuildContext context, DesignThemeExtension colors) {
    return ListView(
      ...
      children: [
        ...
        const Text('Display Large (36px)', style: DesignTypography.display),
        DesignSpacing.spacerV8,
        const Text('Headline Large (28px)', style: DesignTypography.headline),
        DesignSpacing.spacerV8,
        const Text('Title Large (22px)', style: DesignTypography.titleLarge),
        DesignSpacing.spacerV8,
        const Text('Title Medium (18px)', style: DesignTypography.titleMedium),
        DesignSpacing.spacerV8,
        const Text('Body Large (16px)', style: DesignTypography.bodyLarge),
        DesignSpacing.spacerV8,
        const Text('Body Medium (14px)', style: DesignTypography.bodyMedium),
        DesignSpacing.spacerV8,
        const Text('Label Large (14px)', style: DesignTypography.labelLarge),
        DesignSpacing.spacerV8,
        const Text('Label Medium (12px)', style: DesignTypography.labelMedium),
        DesignSpacing.spacerV8,
        const Text('Caption (11px)', style: DesignTypography.caption),
      ],
    );
  }
      ...
      children: [
        ...
        DesignCard.basic(
          child: Column(
            ...
            children: [
              const Text('Tarjeta Básica', style: DesignTypography.titleMedium),
              DesignSpacing.spacerV8,
              const Text('Tarjeta con bordes sutiles sin sombra.', style: DesignTypography.bodyMedium),
            ],
          ),
        ),
        ...
        DesignCard.elevated(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Tarjeta Elevada', style: DesignTypography.titleMedium),
              DesignSpacing.spacerV8,
              const Text('Tarjeta con elevación y sombras suaves.', style: DesignTypography.bodyMedium),
            ],
          ),
        ),
        DesignSpacing.spacerV24,
        ...
        DesignCard.info(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Tarjeta Informativa', style: DesignTypography.titleMedium),
              DesignSpacing.spacerV8,
              const Text('Tarjeta con fondo azul claro decorado.', style: DesignTypography.bodyMedium),
            ],
          ),
        ),
        DesignSpacing.spacerV16,
        DesignCard.status(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Tarjeta de Estatus Exitoso', style: DesignTypography.titleMedium),
              DesignSpacing.spacerV8,
              const Text('Tarjeta con borde verde de éxito.', style: DesignTypography.bodyMedium),
            ],
          ),
        ),
      ],
